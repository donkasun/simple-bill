...
async function run() {
  ...
  // Disable entrance/pulse animations so the New Invoice CTA is stable for clicks.
  ...
  // Copy from previous + customer picker exist on create page.
  await page.waitForSelector("text=Copy from previous", { timeout: 10_000 });
  await page.waitForSelector("text=Bill To", { timeout: 10_000 });
